...
def check_environment():
    ...
    try:
        ...
        print(f"❌ ERROR: Invalid menu.json format: {e}")
        print("   Please ensure menu.json contains valid JSON data.")
        return False
    except Exception as e:
        print(f"❌ ERROR: Could not read menu.json: {e}")
        return False
...
def print_startup_info():
    ...
    print("   • Payment Callback: http://localhost:8000/payment-callback")
